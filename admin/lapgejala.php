...
$kdsakit = ''; // Variabel $kdsakit didefinisikan kosong untuk menghindari error
  ...
  <td width="305" >
   <select name="CmbPenyakit">
	...
	while ($datap=mysqli_fetch_array($qryp)) {
		// Menandai opsi yang dipilih berdasarkan $kdsakit
		$selected = ($datap['kd_penyakit'] == $kdsakit) ? "selected" : "";
		echo "<option value='" . $datap['kd_penyakit'] . "' $selected>
